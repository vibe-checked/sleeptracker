...
export default function HealthCards({ health }: Props) {
  ...
  return (
    <View style={{ flexDirection: 'row', flexWrap: 'wrap', justifyContent: 'space-between' }}>
      ...
      <MetricCard label="SpO2" value={health.spo2 > 0 ? health.spo2.toFixed(1) : '—'} unit={health.spo2 > 0 ? '%' : ''} sub={health.spo2 > 0 ? 'Blood oxygen' : 'No Blood Oxygen data'} color={theme.ring1} icon="◉" delay={200} />
